...
if __name__ == '__main__':
    ...
    data = {  # 這裡是你的資料結構
        '標案名稱': '113年度舊庄農地重劃區小排20等緊急農水路改善工程',
        '標案案號': '雲林113J206',
        '年度': '113',
    ...
    for root, dirs, files in os.walk(target_folder):
        ...
        # replace_text_within_percent_signs(file_path, data,"TMP")
        # break

    # 使用 glob 獲取所有 .docx 文件
    # bid_form_path = r'D:\Python\st_docx\src\廠商投標表單\*.docx'
    # for file_path in glob.glob(bid_form_path):
    #     replace_text_within_percent_signs(file_path, data,"TMP")